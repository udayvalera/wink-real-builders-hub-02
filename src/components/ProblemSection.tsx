          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <button 
                ...
                className="bg-red-500 hover:bg-red-600 text-white font-bold text-lg px-8 py-4 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg"
              >
                Challenge Yourself
              </button>
            </div>
